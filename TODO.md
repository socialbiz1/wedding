...
- [x] **갤러리 사진** — 40장 반영 완료 (웹 최적화 244MB→5.5MB, 원본은 `photos_originals/`에 로컬 백업, 2026-07-13)
- [x] **계좌번호** — 신랑(국민)·신부(농협) 반영 완료 (2026-07-13)
- [x] **혼주 전화번호** — 4명 모두 반영 완료 (2026-07-14)
- [x] **신부 요청사항 11건** — 풀컷 히어로·인사말·식사안내·글씨 크기 등 반영 (2026-07-14)
- [ ] **갤러리 사진 순서** — 두 분이 같이 고른 후 순서 전달 예정
- [x] **카카오 JS 키** — 등록 완료, 카톡 공유 활성화 (2026-07-13)
